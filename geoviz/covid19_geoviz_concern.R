...
concern_map <- function(world="world", who="himself"){
    ...
    p <- ggplot(as.data.frame(processed_world_map))+
        ...
        scale_fill_distiller(palette="RdYlBu", name = "Concerned about consequences of the coronavirus ?", limits = c(0, 5), breaks = c(1,2,3,4,5,6), labels= c("1 - Strongly disagree","2 - Disagree","3 - Slightly disagree","4 - Slightly agree","5 - Agree","6 - Strongly agree"))+
        theme_void()
}
